...
from win_automation.utils import AutomationUtils, WindowsUtils


class TestWindowsUtils:
    """Test cases for WindowsUtils class."""

    @patch('win_automation.utils.windows.WIN32_AVAILABLE', True)
    @patch('win_automation.utils.windows.win32clipboard')
    ...
    @patch('win_automation.utils.windows.WIN32_AVAILABLE', False)
...
class TestAutomationUtils:
    ...
    @patch('win_automation.utils.windows.PYWINAUTO_AVAILABLE', True)
    @patch('win_automation.utils.windows.pywinauto')
    ...
    @patch('win_automation.utils.windows.PYWINAUTO_AVAILABLE', False)
